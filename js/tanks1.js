...
var game = new Phaser.Game(gameWidth, gameHeight, Phaser.AUTO, 'phaser-example', { preload: preload, create: eurecaClientSetup, update: update, render: render });
...
var onScreenChange = function(){
	...
	document.documentElement.style.maxWidth = 0;
	document.documentElement.style.maxHeight = 0;
